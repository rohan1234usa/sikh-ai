                        ...
                        <div className="space-y-6 text-center md:text-left">
                            ...
                            <div className="space-y-4">
                                <p className="text-ink-muted leading-relaxed font-medium">
                                    Computer Science undergraduate at <span className="text-ink font-bold">UC Irvine</span> (Class of &apos;27) with a relentless passion for AI/ML and Full Stack engineering.
                                </p>
                                <p className="text-ink-faint text-sm leading-relaxed">
                                    This platform leverages <span className="text-emerald-600 dark:text-emerald-400 font-semibold">Generative AI</span> to bridge the gap between ancient wisdom and modern technology. It represents the intersection of spiritual heritage and state-of-the-art language models.
                                </p>
                            </div>

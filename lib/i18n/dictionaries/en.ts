...
const en = {
    ...
    chat: {
        ...
        shareDialog: {
            title: 'Share chat',
            close: 'Close',
            signedOut: 'A shared link is a public, read-only copy of this chat. Sign in with Google to create one.',
            ...
            stale: 'This chat has new messages since the link was made.',
            update: 'Update link',
            updating: 'Updating…',
            updated: 'Link updated with the latest messages.',
            unshare: 'Stop sharing',
            unsharePrompt: 'Stop sharing? The link will stop working.',
            unsharing: 'Stopping…',
            unshared: 'This chat is no longer shared.',
            waitForReply: 'Wait for the reply to finish, then share.',
            nothingYet: 'There is no answer in this chat to share yet.',
            truncated: 'This chat is too long to share whole, so the link has its most recent part.',
    ...
    // The public page a shared link opens
    share: {
        badge: 'Shared conversation',
        sharedOn: 'Shared {date}',
        disclaimer: 'A read-only copy of a conversation with SikhAI. SikhAI can make mistakes — verify Gurbani quotes.',
        truncated: 'Earlier messages are not included in this copy.',
        continue: 'Continue this conversation',
        continuing: 'Opening…',
        continueError: "Couldn't open this conversation. Please try again.",
        newChat: 'Start a new chat',
        loading: 'Loading shared chat…',
        loadError: "Couldn't load this shared chat. Check your connection and try again.",
        unavailableHeading: "This shared chat isn't available",
        unavailableBody: 'The link may be mistyped, or the person who shared it stopped sharing.',
    },

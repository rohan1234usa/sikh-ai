...
const en = {
    ...
    chat: {
        ...
        autoLanguageNote: 'Follows the site language — now {language}',
        answerSettingsAria: 'Answer settings',
        ...
        disclaimerLocal: 'SikhAI can make mistakes — verify Gurbani quotes. Each message goes to Google Gemini with your recent conversation; your chats are saved only in this browser.',
        disclaimerAccount: 'SikhAI can make mistakes — verify Gurbani quotes. Each message goes to Google Gemini with your recent conversation; your chats are saved to your account.',
        charCount: '{n} / {max}',
        ...
        notFoundBody: "It may have been deleted, or it's saved in another browser or account.",
        notFoundSignIn: 'If it was saved to your account, sign in to see it.',
        ...
        history: {
            ...
            syncedHint: 'Chats are saved to your account.',
            signInHint: 'Sign in to keep your chats on all your devices.',
            accountUnavailable: "Your account can't save chats right now, so new ones are saved in this browser.",
            moveTitle: 'Chats on this browser',
            moveBody: 'Move them to your account to see them wherever you sign in.',
            moveAction: 'Move to account',
            moveNotNow: 'Not now',
    ...
    translate: {
        ...
        copiedAria: 'Copied',
        copyAll: 'Copy all',
        fallbackNotice: 'Basic translation from Google Translate — Roman spelling, word-by-word, and learning aids aren’t available right now.',
        retryFull: 'Try the full translation again',
        crosscheck: 'Compare with Google Translate',
        crosschecking: 'Checking…',
        crosscheckLabel: 'Google Translate',
        crosscheckError: 'Couldn’t reach Google Translate. Try again later.',
